...
{
	/// <summary>
	/// Direct copy from Duality.Drawing for the purposes of debugging.
	/// </summary>
    public class MyFormattedText : ICloneExplicit
    {/// <summary>
	 ...
	 /// </summary>
		...
		{
			// General state data
			private MyFormattedText parent;
			...
			public RenderState(MyFormattedText parent)
			{
				this.parent = parent;
		...
		public MyFormattedText() : this((string)null) { }
		public MyFormattedText(string text)
		{
			this.ApplySource(text);
		}
		public MyFormattedText(MyFormattedText other)
		{
